# Gemini QA Agent Guide

Use this reference when adding reviewer, QA, validation, or security specialists to a Agent Team Gemini harness.

## 1. QA Role

QA is a quality gate, not a final checklist. It verifies contracts, integration, evidence, artifact correctness, runtime-state discipline, and tool permissions before the orchestrator advances.
...
| tools | QA has tools needed for validation, workers do not have excessive tools |
...
- agent tool permissions vs role responsibilities
...
- tool permissions -> role responsibility
