# Codex Specialist Roster Examples

Use these examples to pick a concrete Agent Team Codex harness shape. They are not peer-to-peer groups; they are orchestrator-routed specialist rosters using Codex-native skills, agent definitions, artifacts, and optional delegation.
...
2. If delegation is allowed, run the two researchers independently; otherwise perform the two lanes directly using the same output contracts.
...
2. Reviewer verifies tests, behavior, and integration contracts.
...
4. Orchestrator reports changed files and verification.
