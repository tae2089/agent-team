...
- If design interview handed off after routing refusal, lock only the routing decision or identify the missing planning term, then return to the designer path; do not restart open-ended design discovery without a new routing signal.
